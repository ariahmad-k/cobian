<!-- login khusus karyawan berdasarkan inputan owner yaaa bestttt -- -->
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($nama) && !empty($password) && !empty($jabatan)) {
        $query = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE nama='$nama' AND password='$password' AND jabatan='$jabatan'");
